...
export default function Members() {
  ...
  return (
    <Section
      id="members"
      className="relative bg-gradient-to-b from-sky-turquoise/10 to-cactus-green/10"
    >
      <div className="relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {members.map((member) => (
            <Card
              key={member.id}
              className="text-center hover:shadow-xl hover:shadow-primary/20"
            >
              <div className="mb-4">
                ...
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold border ${getTrackColor(
                      member.track
                    )}`}
                  >
                    {member.track} Track
