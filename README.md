...
このプロジェクトは既存のVite構成をベースにZAGARO公式HPを構築したものです。

**サイト名**: ZAGARO  
**キャッチコピー**: あなたの可能性を、技術で解き放つ。  
**目的**: 静岡県立大学発のエンジニアサークル紹介・メンバー募集  
**スタイルトーン**: 自然 × 未来的 × 勢い（緑系＋シアン、ダークベース）
...
- HeroセクションにGSAP / Lottieアニメーション追加予定
- より高度なパララックス効果の実装
- インタラクティブな要素の追加